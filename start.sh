...
#java -javaagent:/app/async-profiler-3.0-linux-x64/lib/libasyncProfiler.so=start,event=cpu -cp ".:javax.jms-api-2.0.1.jar:log4j-core-2.23.1.jar:log4j-api-2.23.1.jar:jedis-2.9.0.jar:activemq-all-5.18.6.jar:activemq-client-5.18.6.jar:gson-2.11.0.jar" EFD_Generator
